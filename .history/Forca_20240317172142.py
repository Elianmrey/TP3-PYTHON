...
def main(letter):
     ...
     while True:
          ...
          for i in range(len(letter)):
               guess_word, have_letter  = hanged(hidden,guess_word , letter[i])
               ...
               if is_letter(letter[i]):
                    repeated_char,is_repeated = char_repeat_control(repeated_char,letter[i])
                    if(not is_repeated):
                          if (have_letter):
                              print(f"A letra '{letter[i]}' existe na palavra. Voce acertou")
                              #print(guess_format_word)
