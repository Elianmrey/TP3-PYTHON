...
def letter_repeat_control(letter):
     """This function checks if the user has entered a repeated letter. If so, it returns True; otherwise False."""
    global characters, password, errors
...
guess_word=[]
word, booleano  = hanged(hidden,guess_word , "a")                
for i in range(7):
      hanged_design(i)
print(word, booleano)